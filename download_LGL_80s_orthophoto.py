...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 13 15:46:12 2025

@author: paulmayer

This script downloads a 20x20 m DOP of a year in the 80´s for a given coordinate in Baden-Wuerttemberg.
"""
...
def get_LGL_1980s_DOP(latitude, longitude, output_dir=None):
...
if __name__ == "__main__":
    ...
    if lat is not None and lon is not None:
        success = get_LGL_1980s_DOP(lat, lon)