...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 13 13:59:51 2025

@author: paulmayer

This script downloads a 20x20 m DOP of a year in the 70´s for a given coordinate in Baden-Wuerttemberg.
"""
...
def get_LGL_1970s_DOP(latitude, longitude):
    ...
    # prepare paths
    download_dir = os.path.join(script_dir, "Downloads/LGL/Historical/1970_1979")
...
if __name__ == "__main__":
    ...
    if lat is not None and lon is not None:
        success = get_LGL_1970s_DOP(lat, lon)